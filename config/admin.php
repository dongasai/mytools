...
use Modules\DcatAdmin\DcatAdmin\Grid\Displayers\LineActions;
...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;' . env('APP_TITLE', '开发者') ,
   ...
   */
    ...
    */
    'grid' => [
        ...
        'grid_action_class' => LineActions::class,
    ...
    */
    'database' => [
        ...
        'menu_model' => \Modules\DcatAdmin\Models\Menu::class,
