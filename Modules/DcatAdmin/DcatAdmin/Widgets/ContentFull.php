...
class ContentFull extends Widget implements Renderable
{
     ...
     * @var string
     */
    protected $view = 'module_dcatadmin::widgets.layouts.full-content';
    ...
    {
        return $this->view('module_dcatadmin::widgets.layouts.full-content');
    }
